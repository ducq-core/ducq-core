...
ducq_dispatcher *ducq_reactor_get_dispatcher(ducq_reactor * srv);
...
bool ducq_reactor_set_monitor_route(ducq_reactor *srv, bool is_allowed);
...
void ducq_reactor_set_log(ducq_reactor *srv, void* ctx, ducq_log_f log);
void ducq_reactor_set_default_log(ducq_reactor *srv);
int ducq_reactor_log(ducq_reactor *srv, enum ducq_log_level level, const char *function_name, const char *sender_id, const char *fmt, ...);
